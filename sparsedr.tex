...
\section{Introduction}
    ...
    % (TODO: Edge sampling). Следом появилось несколько методов, также применимых в физически-обоснованном
    % рендеринге, которые использовали естественные для этой экосистемы меши и SDF в
    % качестве оптимизируемого представления. Последние являются более подходящими для
    % этой задачи, так как меши обладают рядом существенных недостатков [Nicolet].

    This method. Tell about modifications. Tell about SDFs, grids, then (2022 article about SVS/SBS/etc.).
